package gonzalez.jesus.popcornfactory
...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        peliculas.add(Pelicula("Big hero", R.drawable.bighero6, R.drawable.headerbighero6,
            "When a devastating event befalls the city of San Fransokyo and catapults Hiro " +
                    ...
                    "junkie Go Go  Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy " +
                    "Fred. Determined to  uncover the mystery, Hiro transforms his friends into a " +
                    "band of high-tech heroes called  Big Hero 6"))
        peliculas.add(
            Pelicula("1917", R.drawable.war, R.drawable.warheader, "British trenches somewhere in France. World war has been going on for the third year,\n" +
        ...
        peliculas.add(Pelicula("Dr. Who", R.drawable.drwho, R.drawable.drwhoheader, "The numerous miraculous rescues by the local wonder boy Clark have aroused suspicions amongst\n" +
        ...
        peliculas.add(Pelicula("Friends", R.drawable.friends, R.drawable.friendsheader, "Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39; travels across the\n" +
        ...
        peliculas.add(Pelicula("Smallville", R.drawable.smallville, R.drawable.smallvilleheader, "Rachel Green, Ross Geller, Monica Geller, Joey Tribbiani, Chandler Bing and Phoebe Buffay are\n" +
    ...
    class PeliculaAdapter  : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            vista.iv_pelicula.setImageResourse(pelicula.image)
